    ...
    try:
        ...
        for lstedge in lt.iterator(lstmap):
            for edge in lt.iterator(lstedge):
                ...
                # TODO: This seems to fail if the undirected graph has multiple
...
def addEdge(graph, vertexa, vertexb, weight=0, name='', reversed_name=''):
    """
    ...
    Args:
        ...
        name: Nombre descriptivo para el arco de vertexa a vertexb
        reversed_name: Nombre descriptivo para el arco de vertexb a vertexa
    ...
    try:
        # Se crea el arco
        edge = e.newEdge(vertexa, vertexb, weight, name)
        ...
        if (not graph['directed']):
            ...
            edgeb = e.newEdge(vertexb, vertexa, weight, reversed_name)
