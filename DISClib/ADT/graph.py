...
def addEdge(graph, vertexa, vertexb, weight=0, name="", reversed_name=""):
    ...
    Args:
        ...
        name: Nombre descriptivo para el arco entre vertexa y vertexb
        reversed_name: Nombre descriptivo para el arco entre vertexb y vertexa
    ...
    Raises:
        Exception
    """
    return graph['datastructure'].addEdge(graph, vertexa, vertexb, weight, name, reversed_name)
